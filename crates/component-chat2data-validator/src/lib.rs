...
mod bindings {
    wit_bindgen::generate!({ path: "wit/chat2data-validator", world: "component-v0-v6-v0", generate_all });
}
    ...
    match mode {
        ...
        Mode::Setup => QaSpec {
            ...
            questions: vec![QaQuestionSpec {
                ...
                label: i18n("chat2data-validator.schema.config.strict_mode"),
                help: None,
                error: None,
    ...
    fields.insert(
        ...
        SchemaField {
            ...
            schema: SchemaIr::Bool {
                title: i18n("chat2data-validator.schema.output.valid"),
...
fn config_schema() -> SchemaIr {
    ...
    fields.insert(
        ...
        SchemaField {
            required: false,
            schema: SchemaIr::Bool {
                title: i18n("chat2data-validator.schema.config.strict_mode"),
