...
pub fn input_schema() -> SchemaIr {
    ...
    fields.insert(
        ...
        SchemaField {
            ...
            schema: SchemaIr::String {
                title: i18n("tavily.schema.input.token.title"),
                description: i18n("tavily.schema.input.token.description"),
                format: None,
                secret: true,
            },
        },
    ...
    SchemaIr::Object {
        title: i18n("tavily.schema.input.title"),
        description: i18n("tavily.schema.input.description"),
        fields,
...
pub fn output_schema() -> SchemaIr {
    ...
    fields.insert(
        ...
        SchemaField {
            ...
            schema: SchemaIr::Bool {
                title: i18n("tavily.schema.output.ok.title"),
                description: i18n("tavily.schema.output.ok.description"),
            },
        },
    );
    fields.insert(
        ...
        SchemaField {
            required: false,
            schema: SchemaIr::String {
                title: i18n("tavily.schema.output.error.title"),
                description: i18n("tavily.schema.output.error.description"),
                format: None,
                secret: false,
            },
        },
    ...
    SchemaIr::Object {
        title: i18n("tavily.schema.output.title"),
        description: i18n("tavily.schema.output.description"),
        fields,
        additional_properties: true,
    }
}
