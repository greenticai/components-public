//! Pure shared HTTP call type and query-string encoding for the ClickUp
...
#![allow(dead_code)]
/// HTTP method for a REST API request.
...
/// A single REST API request, decoupled from the WIT host call so it
