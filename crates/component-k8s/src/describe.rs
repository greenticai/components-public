...
pub fn input_schema() -> SchemaIr {
    ...
    fields.insert(
        ...
        SchemaField {
            ...
            schema: SchemaIr::String {
                title: i18n("k8s.schema.input.api_url.title"),
                description: i18n("k8s.schema.input.api_url.description"),
                format: None,
                secret: false,
            },
        },
    ...
    fields.insert(
        ...
        SchemaField {
            required: true,
            schema: SchemaIr::String {
                title: i18n("k8s.schema.input.token.title"),
                description: i18n("k8s.schema.input.token.description"),
                format: None,
                secret: true,
            },
        },
    ...
    SchemaIr::Object {
        title: i18n("k8s.schema.input.title"),
        description: i18n("k8s.schema.input.description"),
        fields,
...
pub fn output_schema() -> SchemaIr {
    ...
    fields.insert(
        ...
        SchemaField {
            ...
            schema: SchemaIr::Bool {
                title: i18n("k8s.schema.output.ok.title"),
                description: i18n("k8s.schema.output.ok.description"),
            },
        },
    );
    fields.insert(
        ...
        SchemaField {
            required: false,
            schema: SchemaIr::String {
                title: i18n("k8s.schema.output.error.title"),
                description: i18n("k8s.schema.output.error.description"),
                format: None,
                secret: false,
            },
        },
    ...
    SchemaIr::Object {
        title: i18n("k8s.schema.output.title"),
        description: i18n("k8s.schema.output.description"),
        fields,
        additional_properties: true,
    }
}
