...
//! Twilio SMS for Greentic flows.
//!
//! `greentic.twilio` ships its tools as a DESIGN extension, which makes them
...
pub fn i18n_keys() -> Vec<String> {
    [
        ...
        "twilio.schema.input.token.title",
        "twilio.schema.input.token.description",
        ...
        "twilio.schema.output.error.title",
        "twilio.schema.output.error.description",
    ]
    .iter()
    .map(|k| (*k).to_string())
    .collect()
...
impl node::Guest for Component {
    fn describe() -> node::ComponentDescriptor {
        node::ComponentDescriptor {
            ...
            summary: Some("Twilio SMS for Greentic flows".to_string()),
