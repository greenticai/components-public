...
pub fn input_schema() -> SchemaIr {
    ...
    fields.insert(
        ...
        SchemaField {
            ...
            schema: SchemaIr::String {
                title: i18n("calendly.schema.input.token.title"),
                description: i18n("calendly.schema.input.token.description"),
                format: None,
                secret: true,
            },
        },
    ...
    SchemaIr::Object {
        title: i18n("calendly.schema.input.title"),
        description: i18n("calendly.schema.input.description"),
        fields,
...
pub fn output_schema() -> SchemaIr {
    ...
    fields.insert(
        ...
        SchemaField {
            ...
            schema: SchemaIr::Bool {
                title: i18n("calendly.schema.output.ok.title"),
                description: i18n("calendly.schema.output.ok.description"),
            },
        },
    );
    fields.insert(
        ...
        SchemaField {
            required: false,
            schema: SchemaIr::String {
                title: i18n("calendly.schema.output.error.title"),
                description: i18n("calendly.schema.output.error.description"),
                format: None,
                secret: false,
            },
        },
    ...
    SchemaIr::Object {
        title: i18n("calendly.schema.output.title"),
        description: i18n("calendly.schema.output.description"),
        fields,
        additional_properties: true,
    }
}
