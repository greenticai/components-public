//! Pure shared HTTP call type and query-string encoding for the Calendly
...
#![allow(dead_code)]
/// HTTP method for a Calendly REST API request.
...
/// A single Calendly REST API request, decoupled from the WIT host call so
/// it can be constructed and asserted on in pure unit tests.
