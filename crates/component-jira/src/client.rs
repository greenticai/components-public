//! Pure shared HTTP call type and query-string encoding for the Jira
...
#![allow(dead_code)]
/// HTTP method for a Jira REST API request.
...
/// A single Jira REST API request, decoupled from the WIT host call so it
